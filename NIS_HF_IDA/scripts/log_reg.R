...
reg_model_died <- svyglm(
  DIED ~ HF_Categories + AGE + FEMALE + RACE + elixsum  + ZIPINC_QRTL + Insurance + Hosp_Census_Region +
    HTN + Hyperlip + PVD + CAD + COPD + Valv_HD + Dementia + CA + Fluid_disorders + Afib + Obesity + Pacemaker + pMI +
    Malnutrition + pCardiacSurg,
  design = dsgn,
...
reg_model_LOS <- svyglm(
  LOS ~ HF_Categories + AGE + FEMALE + RACE + elixsum  + ZIPINC_QRTL + Insurance + Hosp_Census_Region +
    HTN + Hyperlip + PVD + CAD + COPD + Valv_HD + Dementia + CA + Fluid_disorders + Afib + Obesity + Pacemaker + pMI +
    Malnutrition + pCardiacSurg,
  design = dsgn,
  family = "gaussian"
...
reg_model_TOTCHG <- svyglm(
  adj_TOTCHG ~ HF_Categories + AGE + FEMALE + RACE + elixsum  + ZIPINC_QRTL + Insurance + Hosp_Census_Region +
    HTN + Hyperlip + PVD + CAD + COPD + Valv_HD + Dementia + CA + Fluid_disorders + Afib + Obesity + Pacemaker + pMI +
    Malnutrition + pCardiacSurg,
  design = dsgn,
  family = "gaussian"
