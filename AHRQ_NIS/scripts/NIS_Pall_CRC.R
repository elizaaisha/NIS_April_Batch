...
dta_clean <- dta_base |>
  mutate(
    Colo_Rect_CA = case_when(
      str_detect(DX10_Combined, "C18.*") ~ "Yes",
      str_detect(DX10_Combined, "C19.*") ~ "Yes",
      str_detect(DX10_Combined, "C20.*") ~ "Yes",
      str_detect(DX10_Combined, "C21.*") ~ "Yes",
      .default = "No"
    ),
    Pall_Care = case_when(
    ...
    Pall_Care_CRC = case_when(Pall_Care == "Yes" & Colo_Rect_CA == "Yes" ~ "Yes",
                             .default = "No"),
