...
# Import data
dta <- arrow::open_dataset("./nis_data/NIS_Stroke_Afib_Urban.parquet/")
...
arrow::write_parquet(dta_sample, "./nis_data/NIS_Stroke_Afib_Urban_testing.parquet")

# Load sampled testing data
testing_dta <- read_parquet("./nis_data/NIS_Stroke_Afib_Urban_testing.parquet")
